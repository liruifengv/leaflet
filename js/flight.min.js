function Flight(a, b) {
    ...
    this.init = function (a, b) {
      ...
      this.road = this.group_road.append("path").data(this.road_points).attr("stroke", this.roadColor).attr("stroke-width", 1.5).attr("stroke-dasharray", "10 5").attr("fill", "none").attr("d", d3.line().curve(d3.curveBundle.beta(.5)));
    ...
    this.load_plane = function () {
      console.log("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
      console.log("road",this.road.node());
      console.log("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
        var a = this.w_plane,
          b = this.h_plane,
          c = this.pos_plane.x,

L.ColorPicker = LeafletToolbar.ToolbarAction.extend({
	...
	initialize: function(mymap, shape, options) {
		this._shape = shape;

		L.setOptions(this, options);
		LeafletToolbar.ToolbarAction.prototype.initialize.call(this, mymap, options);
	},
	...
	_createIcon: function(toolbar, container, args) {
		...
		L.DomEvent.on(this._link, 'click', function() {
			mymap.removeLayer(this.toolbar.parentToolbar);
		}, this);
	}
});